...
module.exports = {
  ...
  description: '<div clas="mb-block"><p><strong>Get the data how you want it!</strong></p> <p>Want to sort the CCJ Top 250 by revenues or number of trucks, tractors, trailers or drivers? Want to see and sort carriers by type of haul or geographic region? Want a copy of the CCJ Top 250 data in a PDF file?</p></div>',
  downloadLink: '/##########',
