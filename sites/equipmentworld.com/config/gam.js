...
config
  ...
  .setAliasAdUnits('heavy-equipment', [
    { name: 'leaderboard', templateName: 'LEADERBOARD', path: 'heavy-equipment-leaderboard' },
    { name: 'rotation', templateName: 'ROTATION', path: 'heavy-equipment-rotation' },
    { name: 'inline-content-mobile', templateName: 'INLINE-CONTENT-MOBILE', path: 'heavy-equipment-rotation' },
    { name: 'inline-content-desktop', templateName: 'INLINE-CONTENT-DESKTOP', path: 'heavy-equipment-rotation' },
  ])
  .setAliasAdUnits('roadbuilding-equipment', [
    { name: 'leaderboard', templateName: 'LEADERBOARD', path: 'roadbuilding-equipment-leaderboard' },
    { name: 'rotation', templateName: 'ROTATION', path: 'roadbuilding-equipment-rotation' },
    { name: 'inline-content-mobile', templateName: 'INLINE-CONTENT-MOBILE', path: 'roadbuilding-equipment-rotation' },
    { name: 'inline-content-desktop', templateName: 'INLINE-CONTENT-DESKTOP', path: 'roadbuilding-equipment-rotation' },
  ])
  ...
  .setAliasAdUnits('light-equipment', [
    { name: 'leaderboard', templateName: 'LEADERBOARD', path: 'light-equipment-leaderboard' },
    { name: 'rotation', templateName: 'ROTATION', path: 'light-equipment-rotation' },
    { name: 'inline-content-mobile', templateName: 'INLINE-CONTENT-MOBILE', path: 'light-equipment-rotation' },
    { name: 'inline-content-desktop', templateName: 'INLINE-CONTENT-DESKTOP', path: 'light-equipment-rotation' },
  ])
