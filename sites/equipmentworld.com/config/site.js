...
module.exports = {
  ...
  logos: {
    navbar: {
      src: 'https://img.equipmentworld.com/files/base/randallreilly/all/image/static/eqw-logo.svg?h=45&auto=format,compress&q=70',
      srcset: [
        'https://img.equipmentworld.com/files/base/randallreilly/all/image/static/eqw-logo.svg?h=90&auto=format,compress&q=70 2x',
      ],
    },
    footer: {
      src: 'https://img.equipmentworld.com/files/base/randallreilly/all/image/static/eqw-logo.svg?h=60&auto=format,compress&q=70',
      srcset: [
        'https://img.equipmentworld.com/files/base/randallreilly/all/image/static/eqw-logo.svg?h=120&auto=format,compress&q=70 2x',
      ],
    },
  },
  socialMediaLinks: [
