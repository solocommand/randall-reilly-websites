...
module.exports = {
  ...
  logos: {
    navbar: {
      src: 'https://img.equipmentworld.com/files/base/randallreilly/all/image/static/eqw-logo.svg?h=45',
      srcset: [
        'https://img.equipmentworld.com/files/base/randallreilly/all/image/static/eqw-logo.svg?h=90 2x',
      ],
    },
    footer: {
      src: 'https://img.equipmentworld.com/files/base/randallreilly/all/image/static/eqw-logo.svg?h=60',
      srcset: [
        'https://img.equipmentworld.com/files/base/randallreilly/all/image/static/eqw-logo.svg?h=120 2x',
      ],
    },
  },
  socialMediaLinks: [
