...
config
  .setAliasAdUnits('default', [
    { name: 'lb1', templateName: 'LB1', path: 'truckersnews_728x90_Pos1' },
    { name: 'lb2', templateName: 'LB2', path: 'truckersnews_728x90_Pos2' },
    { name: 'rail1', templateName: 'RAIL1', path: 'truckersnews_300x250_Pos1' },
    { name: 'rail2', templateName: 'RAIL2', path: 'truckersnews_300x250_Pos2' },
    { name: 'load-more', templateName: 'LM', path: 'truckersnews_300x250_Pos3' },
