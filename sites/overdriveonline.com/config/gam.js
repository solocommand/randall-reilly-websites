...
config
  .setAliasAdUnits('default', [
    { name: 'lb1', templateName: 'LB1', path: 'Overdrive_728x90_Pos1' },
    { name: 'lb2', templateName: 'LB2', path: 'Overdrive_728x90_Pos2' },
    { name: 'rail1', templateName: 'RAIL1', path: 'Overdrive_300x250_Pos1' },
    { name: 'rail2', templateName: 'RAIL2', path: 'Overdrive_300x250_Pos3' },
    { name: 'load-more', templateName: 'LM', path: 'Overdrive_300x250_Pos3' },
